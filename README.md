...
[![Version](https://img.shields.io/badge/version-v1.2.0-blue.svg)](https://github.com/symi-daguo/smart-home-salary/releases)
...
- 修复仓库构建问题：完善 Tauri 构建配置、解决依赖缺失问题
- 新增 SQLite 桌面种子数据脚本 `seed-desktop.ts`
