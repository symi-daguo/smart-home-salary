...
│   └── SmartHome_1.2.1_x64-setup.exe
├── macos/         # macOS App
│   └── SmartHome.app
├── dmg/           # macOS DMG 安装包
│   └── SmartHome_1.2.1_aarch64.dmg
├── deb/           # Linux DEB 包
│   └── SmartHome_1.2.1_amd64.deb
└── appimage/      # Linux AppImage
    └── SmartHome_1.2.1_amd64.AppImage
```
...
- **日志位置**：`%LOCALAPPDATA%\\com.smarthome.desktop\\logs\\smarthome.log`
